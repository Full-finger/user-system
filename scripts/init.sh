...
rm -f "$SCRIPT_DIR/../configs/config.yaml.bak" "$SCRIPT_DIR/../configs/config.yaml.bak2" "$SCRIPT_DIR/../configs/config.yaml.bak3" "$SCRIPT_DIR/../configs/config.yaml.bak4" "$SCRIPT_DIR/../deployments/docker-compose.yml.bak"
